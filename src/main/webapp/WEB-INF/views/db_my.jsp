...
function search(){
	...
	console.log(maxDay);
	window.location.href = "db_my.do?userName=" + "${userList.userName}" +"&month=" + $("#month option:selected").val().toString() + "&maxDay=" + maxDay;
}
...
function header() {
	return `
			...
			<button type = "button" id = "update_time" onclick = "fn_update_time();">수정</button>
